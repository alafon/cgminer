...
//#define HEXMINER8_ARRAY_SIZE 253
#define HEX8_NONCE_CASH_SIZE				1
#define HEXMINER8_PUSH_THRESH		8       /* At least 9 queued works available to be written to PIC */
#define HEXMINER8_ARRAY_MAX_POP		1
#define HEX8_USB_R_SIZE					64
#define HEX8_USB_WR_SIZE					64
#define HEX8_HASH_BUF_SIZE				2048*4
#define HEX8_USB_TIMING						50 * 1000
#define HEX8_USB_R_BAD_ID					32

#define HEXMINER8_BULK_READ_TIMEOUT 500
#define HEX8_USB_WR_TIME_OUT				500


#define HEX8_USB_RES_THRESH				400     //About 2 sec with consecutive failed reads
#define HEX8_MAX_START_DELAY_MS		1000
...
struct work8_result
{
  ...
  uint8_t dum;                  //7
  //uint32_t recived_jobs;  //1x32
  //uint32_t found_nonces;  //1x32
...
struct hexminer8_info
{
  ...
  double last_chip_valid_diff[HEX8_DEFAULT_ASIC_NUM];
#endif
  bool reset_work;
