...
#ifdef USE_HEXMINERC
#include "util.h"
#define HEXC_POWER_BLOCK
//#define DBG_HEXC
//#define DBG_HEXC_BUF
#define DBG_TIMEC 7

//#define DBG_HEXC_USB
//#define SKIP_HEXC_USB_RES
#ifdef DBG_HEXC_USB
#define HEXC_USB_WR_TIME_OUT				0
#define HEXMINERC_BULK_READ_TIMEOUT		500
...
#define HEXMINERC_WORK_FACTOR		0.84    /* We need to be aggressive and fill PIC faster than time taken for a job
